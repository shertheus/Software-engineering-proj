package com.lyl.facerecognition.Utils.View;
...
public class TableView extends View {
    ...
    private List<Integer> mCoordinateXValues = new ArrayList<>();// 外界传入
    ...
    public void setupCoordinator(String xUnit, String yUnit, float[] coordinateXValues) {
        mXUnit = xUnit;
        mYUnit = yUnit;
        for (int i = 0; i < coordinateXValues.length; i++){
            mCoordinateXValues.add((int)coordinateXValues[i]);
        }
    }
     ...
     * @param values
     */
    public void addWave(int color, boolean isCoverRegion, List<Float> values) {
    ...
    public static class WaveConfigData {
        ...
        public WaveConfigData(int color, boolean isCoverRegion, List<Float> values) {
            this.color = color;
